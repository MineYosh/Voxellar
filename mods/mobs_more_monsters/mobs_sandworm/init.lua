...
if mobs.mod and mobs.mod == "redo" then
	...
	local spice_duration = 30.0		--seconds
	local spice_buff_speed = 1.5		--add to physics multiplier
	local spice_buff_jump = 1		--add to physics multiplier
	local spice_buff_gravity = 0.5	--subtract from physics multiplier
	...
	mobs:register_mob("mobs_sandworm:sandworm", {
		...
		visual_size = {x=2, y=2},
		collisionbox = {-0.6, -0.1, -0.6, 0.6, 1.70, 0.6},
		speed_normal = 25,
		speed_run = 40,
		stand_start = 0,
		stand_end = 0,
